// lnpz_linalg.h - Local copy of the linalg library by Sterling Orsten with some
// computational geometry added.
//
// Minor tweaks related to local use might be implemented.
// Please see linalg.h original attribution below. 
//
